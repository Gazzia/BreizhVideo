...
-- -----------------------------------------------------
-- Table `breizhvideo`.`country`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `breizhvideo`.`country` (
...
-- -----------------------------------------------------
-- Table `breizhvideo`.`city`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `breizhvideo`.`city` (
  ...
  CONSTRAINT `fk_city_country`
    ...
    REFERENCES `breizhvideo`.`country` (`country_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 601
...
DELIMITER $$
USE `breizhvideo`$$
CREATE DEFINER=`admin`@`%` FUNCTION `inventory_held_by_customer`(p_inventory_id INT) RETURNS int
    READS SQL DATA
BEGIN
